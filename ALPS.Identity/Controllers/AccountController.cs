using ALPS.Identity.Models;
using ALPS.Identity.Models.AccountViewModels;
using ALPS.Identity.Quickstart.UI;
using ALPS.Identity.Services;
...
namespace ALPS.Identity.Controllers
{
    [Authorize]
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser {
                    ...
                    AccountExpires = DateTime.UtcNow.AddYears(1)
                };
