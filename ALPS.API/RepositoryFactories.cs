    ...
    public class RepositoryFactories
    {
        ...
        private IDictionary<Type, Func<DbContext, object>> GetFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
       //            {typeof(IRepossessorRepository), dbContext => new RepossessorRepository(dbContext)},
				   //{typeof(IAgentRepository), dbContext => new AgentRepository(dbContext)},
				   //{typeof(ILienholderRepository), dbContext => new LienholderRepository(dbContext)},
                   {typeof(ILocationRepository), dbContext => new LocationRepository(dbContext)},
       //            {typeof(IMakeRepository), dbContext => new MakeRepository(dbContext)},
       ...
       //            {typeof(IExpenseTypeRepository), dbContext => new ExpenseTypeRepository(dbContext)},
