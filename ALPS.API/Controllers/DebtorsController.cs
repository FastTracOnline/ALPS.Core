...
namespace ALPS.API.Controllers
{
    ...
    [Route("api/Debtors")]
    public class DebtorsController : ApiBaseController
    {
        private ALPSContext context;

        public DebtorsController(ALPSContext _context)
        {
            context = _context;
        }
        ...
        public ActionResult PostContact([FromBody] DTO.Contact contact)
        {
            ...
            contact.Active = true;
			contact.RelationToDebtor = RelationshipType.Debtor;
		...
		public void CopyUpdatedFields(DTO.Contact recordIn, ref Contact currentRecord)
		{
			...
			currentRecord.RelationToDebtor = recordIn.RelationToDebtor;
